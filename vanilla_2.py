    ...
    def process_files(self, file_or_dir):
        ...
        if os.path.isdir(file_or_dir):
            ...
            for decade_dir in decade_dirs:
                ...
                for root, dirs, files in os.walk(decade_path):
                    for file in files:
                        if file.endswith(".txt"):
                            file_path = os.path.join(root, file)
                            texts, labels = self.process_file(file_path, decade)
...
book_tokenizer = Tokenizer()
train_texts, train_labels = book_tokenizer.process_files(clean_train_split_path)
